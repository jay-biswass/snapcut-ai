...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative">
      ...
      <div className="glass-card rounded-2xl p-8 w-full max-w-md space-y-6 relative z-10">
        <div className="text-center space-y-2">
          <Link to="/">
            <img src={logo} alt="SnapCut AI" className="h-10 mx-auto" />
          </Link>
        ...
        <form className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input id="password" type={showPassword ? "text" : "password"} placeholder="••••••••" className="pl-9 pr-9" />
          ...
          <Button variant="gradient" className="w-full" type="submit">Create Account</Button>
        </form>
